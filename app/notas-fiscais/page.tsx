          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="mt-1 gm-text-muted">Emitir e gerenciar notas fiscais</p>
              </div>
            </div>
            <button
          ...
          <div className="gm-surface rounded-lg p-6 mb-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium gm-text-muted mb-1">Data de Emissão</label>
                  <input
                    type="date"
                ...
                <div>
                  <label className="block text-sm font-medium gm-text-muted mb-1">Série (opcional)</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium gm-text-muted mb-1">
            ...
            <table className="min-w-full divide-y divide-white/10 gm-table">
              <thead>
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium gm-text-muted uppercase tracking-wider">Número</th>
                  <th className="px-6 py-3 text-left text-xs font-medium gm-text-muted uppercase tracking-wider">Tipo</th>
                  <th className="px-6 py-3 text-left text-xs font-medium gm-text-muted uppercase tracking-wider">Cliente/Fornecedor</th>
              ...
              <tbody className="divide-y divide-white/10">
                {notas.length === 0 ? (
                  ...
                  notas.map((nota) => (
                    <tr key={nota.id}>
                      <td className="px-6 py-4 whitespace-nowrap text-sm">{formatDate(nota.dataEmissao)}</td>
                      ...
                      <td className="px-6 py-4 text-sm">{nota.clienteFornecedor}</td>
